export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'mixtiendago',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Mixtiendago',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'mixtiendago.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://mixtiendago.com',
